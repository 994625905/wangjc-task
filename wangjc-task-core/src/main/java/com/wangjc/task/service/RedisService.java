...
public interface RedisService {
    ...
    boolean hmsetlk(String key, Map<Long, Object> map);

    boolean hmobjset(String key, Map<Object, Object> map);

    boolean hmset(String key, Map<String, Object> map);

    Map<Object, Object> hmget(String key);

    boolean rlock(String key, String value);

    void runlock(String key, String value);
